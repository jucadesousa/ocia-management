...
function OverviewTab() {
  return (
    <div className="space-y-6">
      <Section title="What is Catecheo?">
        <P>
          Catecheo is a parish tool for tracking adults through the Order of Christian Initiation of Adults (OCIA) — formerly known as RCIA. It covers the full journey from initial enrollment through the Easter Vigil, with tools for participant records, weekly attendance, sacramental history, and reporting.
        </P>
      </Section>
  ...
  return (
    <div className="p-6 max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">How to use Catecheo</p>
      </div>
